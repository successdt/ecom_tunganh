...
function vsrp() 
{
	...
	if ( ! empty($vsrp_data) ) 
	{
		...
		foreach ( $vsrp_data as $vsrp_data ) 
		{
			...
			$vsrp_x = $vsrp_x . "vsrp_array[$vsrp_count] = '<div class=\'vsrp_div\' style=\'height:$dis_height;padding:2px 0px 2px 0px;\'><a href=\'$get_permalink\'><div class=\'image\'>". get_the_post_thumbnail($vsrp_data->ID, array(32,32)). "</div><div class=\'title\'>$vsrp_post_title</div></a></div>'; ";	
			$vsrp_count++;
